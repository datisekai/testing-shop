...
//        colordefault();
    ...
    private CacHamQuanTrong cacham;
    ...
    private void initComponents() {
        ...
        lblThongTin_NgayBan1.setForeground(colorText);
        lblThongTin_NgayBan1.setText("Ngày bắt đầu");
        ...
        lblThongTin_MaNV1.setText("Tên CT");
        ...
        lblChiTiet_TiLeKM.setForeground(colorText);
        ...
        lblChiTiet_SoLuong2.setBackground(colorPanel_Center);
...
//        HoaDonDTO hd = new HoaDonDTO();
    ...
    private void btnThongTin_TrongMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThongTin_TrongMouseClicked
        ...
        tfThongTin_MAKM.setText(list_KM.getDefaultMaKM());
    ...
    private void tfThongTin_MAKMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfThongTin_MAKMMouseClicked
        // TODO add your handling code here:
        System.out.println("Click here PLae");
    }//GEN-LAST:event_tfThongTin_MAKMMouseClicked
    ...
    private void btnThongTin_Sua1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnThongTin_Sua1MouseClicked
        ...
        System.out.println(calendarThongTin1.getDate());
    ...
    private void tfThongTin_MAKMActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfThongTin_MAKMActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfThongTin_MAKMActionPerformed
    ...
    private void btnThongTin_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThongTin_ThemActionPerformed
        ...
        String[] s1 = String.valueOf(calendarThongTin1.getDate()).split("\\ ");
        System.out.println(s[2] + " " + s1[1] + " " +s1[5]);
        System.out.println(calendarThongTin1.getDate());
        String Ngay = s1[2] + " " + s1[1] + " " +s1[5];
        
        if ( !cacham.kiemTraDate(NgayBan, Ngay)) 
            JOptionPane.showMessageDialog(null, "Lỗi ngày tháng năm", "Error", JOptionPane.ERROR_MESSAGE);
        else {
            khuyenmai.setStrMaKM(tfThongTin_MAKM.getText());
            khuyenmai.setStrLoaiChuongTrinh((String) cbbThongTin_Loai.getSelectedItem());
            khuyenmai.setStrDieuKien((String) cbbThongTin_DK.getSelectedItem());
    ...
    private void xulyThemChiTietHD(){
        ...
        try {
            if ( !flag ) {
                System.out.println( list_ChiTietKM.them(km) );
            }
            else 
    ...
    private void btnChiTiet_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChiTiet_ThemActionPerformed
        ...
        if (kiemtraKhoaChinh(tfChiTiet_MaSP.getText(), tfChiTiet_MaKM.getText()))
            ...
            JOptionPane.showMessageDialog(null, "Trùng mã sp", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void tfChiTiet_TiLeKMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfChiTiet_TiLeKMMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tfChiTiet_TiLeKMMouseClicked
